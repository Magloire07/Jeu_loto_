...
// TODO add your handling code here:
boolean err=false;             //déclaration d'une variable contenant true ou false selon si le bon solde est saisi 
...
if(ps.equals("")|| err==true){ // gestion d'erreur si le pseudo n'est pas saisi ou  le solde mal saisie ou non saisi
    if(ps.equals("")){
...
//this.dispose();  
    ...
    private void BchoisirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BchoisirActionPerformed
        ...
        Color coul = diag.showDialog(this,"Couleu",Color.red); // affichage de la boite  avec  "couleur" comme tire et "rouge" comme couleur par defaut
