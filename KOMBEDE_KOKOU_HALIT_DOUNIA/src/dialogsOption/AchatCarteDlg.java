  ...
  private void  affMessage(){
   ...
   private void initCarte(){
    ...
    public CarteLoto getCl() {
        ...
        for(Joueur j:ljc.getLst()){
            ListeJoueurs.addItem(j.getPseudo()); // remplissage de la combo avec la liste des joueur disponible dans la Frame laquelle liste est fourni en paramètre du constructeur de la jDialog
        }
    }
    ...
    private void BAutreChoixActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BAutreChoixActionPerformed
        ...
        // on crée une nouvelle instance de carte sinon l'objet celle qui sera transmise au joueur aura la même adresse mais ne se resent pas sur l'affichage car seul les valeur to tableau importe alors que les joueur lui a besoin de deux instance differente de carte
       // cc.setTab(tab);
       for(int i= 0; i<this.nbLig;i++){
            for(int j= 0; j<this.nbCol;j++){
           ...
           {  
               ...
               if(j.getMesCartes().getTaille()<2){
                 ...
                 this.Message.setText("vous disposez de deux cartes dejà");
                   ...
                   System.out.println("vouz n'avez pas assez d'argent pour acheter la carte, elle coût"+cc.getPrix()+"€");
